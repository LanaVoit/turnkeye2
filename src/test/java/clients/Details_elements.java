...
public class Details_elements extends turnkeye2.pages.TestBase {
  ...
  public void testUntitled9() throws Exception {
	    ...
	    assertEquals("http://astrio.ru/media/wysiwyg/portfolio/PinupClothing/.pagespeed.ic.1GhF7nD-_1.webp", driver.findElement(By.xpath("//div[@id='content']/div[2]/div[3]/img[2]")).getAttribute("src"));
